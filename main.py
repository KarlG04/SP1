...
#Boxparameter
box_length = 1.0 # Länge der Box in m
box_height = 0.5 # Häche der Box in m
...
num_time_steps =10 # Anzahl an Berechnungsintervallen
...
gravity = [0.0, 0.0]  # Gravitationskraft in m/s² (x-Komponente, y-Komponente)
...
# Boxpunkte berechnen 
boundary_points, inlet_points, outlet_points = boundary.calculate_box_points(box_length, box_height, spacing, wall_layers)

visualization.visualize_boundary(boundary_points, inlet_points, outlet_points, diameter_particle)

#Fluid_Points, delta_ts = solver.run_simulation(inlet_points, initial_velocity, gravity, cfl, rho, num_time_steps, spacing, boundary_points, eta, initial_pressure)
